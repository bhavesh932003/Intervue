    ...
    return (
      ...
      className="min-h-screen bg-gray-50 relative" >
              ...
              <section className="py-8 bg-transparent z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                  <h1 className="mb-4 text-4xl font-bold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">Your Personal AI Interview Coach</h1>
                  <p className="text-gray-400 mb-8 text-xl font-semibold">Double your chances of landing that job offer with our AI-powered interview prep</p>
